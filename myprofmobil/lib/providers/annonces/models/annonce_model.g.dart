...
AnnonceByCategory _$AnnonceByCategoryFromJson(Map<String, dynamic> json) {
  return AnnonceByCategory(
    id: json['id'] as int,
    catsouscat: (json['catsouscat'] as List)
        ?.map((e) => e == null
            ? null
            : AnnonceByCategory.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    nom: json['nom'] as String,
    description: json['description'] as String,
    image: json['image'] as String,
    ...
    categorie: json['categorie'] == null
        ? null
        : AnnonceByCategory.fromJson(json['categorie'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$AnnonceByCategoryToJson(AnnonceByCategory instance) =>
    <String, dynamic>{
      'id': instance.id,
      'catsouscat': instance.catsouscat,
      'nom': instance.nom,
